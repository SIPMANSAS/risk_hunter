    ...
    <div class="link_int"><div class="titulo2"><i class="fa-solid fa-list"></i><a href="listacompaniaseguros.php"> Regresar</a></div>
      ...
      ?>
        ...
        <?php
                ...
                $firmasasignadasB = $bloques->firmasasignadasB($idusuario);
                while($extraerDatso =  $bloques->obtener_fila($firmasasignadasB)){
                    $numeroI = $extraerDatos['numero_identificacion'];
                ?>
                <div class="contenedor">
                    ...
                    <div class=" campos_f">
                        ...
                        <form action="vercompaniaseguros.php" method="POST">
                ...
                if(isset($_POST['desasignarfirma'])){
                   ...
                   $id = $_POST['id'];
                    ...
                    $desasignarfirma = $bloques->desasignarfirma($tercero,$id);
      ...
      include 'conexion/conexion.php';
      $consultabuscador = $mysqli->query("SELECT * FROM ter_terceros WHERE identificacion = '$id'");
      $extraerdatos = $consultabuscador->fetch_array(MYSQLI_ASSOC);
      $nombrecompania = $extraerdatos['nombres'];
      $numeroidentificacion = $extraerdatos['numero_identificacion'];
      $direccion = $extraerdatos['direccion'];
      $telefono = $extraerdatos['telefono'];
      $correo_electronico = $extraerdatos['correo_electronico'];
      $pais = $extraerdatos['pais'];
      $dep = $extraerdatos['departamento'];
      $ciudad = $extraerdatos['ciudad'];
      $tipdocletra = $extraerdatos['tipdocletra'];
