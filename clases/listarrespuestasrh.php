...
<div class="titulo3"><a href="crearespuestas.php?id='.$identificador.'">Administrar Respuestas</a></div></div>';
    ...
    echo " <div class=\"contenedor\">
          <div class=\"campos\">". $identificador ."</div>
          <div class=\"campos\"> ". $nombre ."</div>
          <div class=\"campos\"> ". $nomtipoestado ."</div>
       <div class=\"campos\"> ". $nombreestado."</div>
        </div> ";
    echo '
    ...
    while ($xrowp = $Json->obtener_fila($result)) {
        ...
        echo " <div class=\"contenedor\">";
        echo "<div class=\"campos\">$nomvalor</div>";
        echo "<div class=\"campos\">$nombreestado </div> ";
        echo "</div>";  
