...
<body>
    ...
    <div class="link_int"><div class="titulo2"><i class="fa-solid fa-list"></i><a href="listarfirmasdesactivadas.php"> Regresar</a></div>
    </div>
      ...
      ?>
        <div class="contenedor">
          <div class="campos_f"><?php echo $nombrefirma ?></div>
