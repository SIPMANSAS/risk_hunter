...
<?php
       ...
       echo ' <div class="titulo3"><i class="fa fa-user-plus"></i><a href="roles.php"> Crear Roles</a></div>
             <div class="titulo3"><i class="fa fa-user-plus"></i><a href="registroroles.php"> Crear Roles B</a></div>
            </div>
...
/* se llama la clase Json */
     ...
     while ($xrowrol = $Json->obtener_fila($result)) {
        ...
        $descripcion = ($xrowrol["descripcion"]);
