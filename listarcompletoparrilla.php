    ...
    if(isset($_POST["identificau"]) or (isset($_POST["idusuario"])))
    {
        ...
        <div class="link_int"><div class="titulo2"><i class="fa-solid fa-download"></i><a Onclick="window.location='exportacion/exportarparrillacompleta.php'"> Exportar Listado Parrilla Completa</a></div>
        </div>
     ...
     <div id="sugerencia"></div>
        ...
        ?>
          ...
          <?php
            ...
            $consultaparrillacompleta = $bloques->consultaparrillacompleta();
            while ($extraerDatos =  $bloques->obtener_fila($consultaparrillacompleta)){
          ?>
            ...
            <div class="contenedor">
               ...
               <div class="campos_f">
                 <form action="encuestaspdf.php" method="POST" target="_blank">
                     <input type="" value="<?php echo $extraerDatos['numero_inspeccion'] ?>" name="inspeccion">
                     <input  type="hidden" value="<?php echo $extraerDatos['identificador'];  ?>" name="identificador">
