...
<body>  
    ...
    /* Inicia llamado del form con sus campos de nombre,apellido, email, telefono etc */
                ...
                echo '</select>';
                if (isset($id))
                    echo '<input name="numident" type="text" value="'.$numident.'"  disabled>';
                else    
                    echo '<input name="numident" type="text" value="'.$numident.'"  required>';
                echo "</div>";
                ...
                /* Hago el select de Pais */
                 ...
                 if(isset($_POST["idpais"]))
                     $xidpais = $_POST["idpais"];
                         ...
                         $xidpais = "1";
                 echo '<div class="inputs_r"><label for="">Ubicacion</label><SELECT name="idpais" id="idpais" >';
            ...
            <div class="btn-action float-clear">
                ...
                <input class="btn_rojo" type="button" name="borrar_registrosrol" value="Borrar Registros" onClick="BorrarRegistrorol();" />
                <span class="success">';
