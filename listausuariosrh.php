...
<body>  
    ...
    ?>
        <div class="titulo_p"><div><i class="fa-solid fa-user"></i></i> Usuarios </div></div>
...
<div class="titulo3"><a href="crearusuariosrh.php?id='.$identificador.'">Administrar Usuario</a></div></div>';
    ...
    echo '
        ...
        <div class="campos_list_u titulo">Fecha Efectiva</div>
        <div class="campos_list_u titulo">Tipo Cliente</div>
    ...
    while ($xrowcl = $Json->obtener_fila($result)) {
        ...
        $tipoidentificacionc = ($xrowcl["tipo_identificacion"]);
        $numeroidentificacionc = $xrowcl["numero_identificacion"];
        $fechaefectivac = $xrowcl["fecha_efectiva"];
        $estadoc = utf8_encode($xrowcl["estado"]);
        $tipotercero = utf8_encode($xrowcl["vdom_tipo_tercero"]);
        
        if($tipotercero == 772){
            $tipotercero = 'Compañia de Seguros';
        }else{
            $tipotercero = 'Firma Inspectora';
        }
        ...
        echo " <div class=\"campos_list_u\">".$fechaefectivac."</div> ";
         echo "<div class=\"campos_list_u\">".$tipotercero."</div>";
...
/*echo '<div class="link_int"><div></div>
<div class="titulo3"><i class="fa-solid fa-user-plus"></i><a href="crearusuariosrh.php"> Crear Usuario</a></div></div>';
*/
echo '<div class="link_int"><div></div>
<div class="titulo3"><i class="fa-solid fa-user-plus"></i><a href="registrousuarios.php"> Crear Usuario </a></div></div>';
