...
function callWebService($identificador, $tipo, $nombre, $codigodep)
{
    ...
    {
        if (isset($codigodep))
            $data = file_get_contents($LINKS.'funciones/obtienedominioglobal.php?codigo='.$tipo.'&identificador='.$identificador.'&codigodep='.$codigodep);
        else
        $data = file_get_contents($LINKS.'funciones/obtienedominioglobal.php?codigo='.$tipo.'&identificador='.$identificador);
    }
    else 
    {
        ...
        {
            $data = file_get_contents($LINKS.'funciones/obtienedominioglobal.php?nombre='.$nombre.'&identificador='.$identificador);
        }
         else    
        {
            $tipo="";
            $nombre="";
            $data = file_get_contents($LINKS.'funciones/obtienedominioglobal.php');
        }
    }
