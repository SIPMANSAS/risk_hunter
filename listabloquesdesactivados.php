    ...
    if(isset($_POST["identificau"]) or (isset($_POST["idusuario"])))
    {
        ...
        <div class="titulo_p">
            <center><i class="fa-solid fa-user"></i>BLOQUES DE PREGUNTA DESACTIVADOS</center>
        </div>
        
        <div class="link_int"><div class="titulo2"><i class="fa-solid fa-list"></i><a href="listarpreguntasrh.php"> Listar Bloques de Pregunta Activos</a></div>
    </div>
     ...
     <div id="sugerencia"></div>
        ...
        */
        ...
        <div class=" titulo"><b>Bloque de preguntas</b></div>
        ...
        <div class=" titulo"><b>Acciones</b></div>
          ...
          <?php
            ...
            $consultabloquesinactivos = $bloques->consultabloquesinactivos();
    
            while ($extraerDatos =  $bloques->obtener_fila($consultabloquesinactivos)){
          ...
          ?>
            <div class="contenedor">
              ...
              <div class="campos_f"><?php echo $extraerDatos['descripcion']; ?></div>
              <div class="campos_f"><?php echo $estado; ?></div>
              ...
              */
              ?>
                <div class="campos_f">
                  <form action="controller/controlleBienes.php" method="POST">
                      <input type="hidden" value="<?php echo $extraerDatos['identificador'];  ?>" name="id">
                      <button class="btn_verde" type="submit" name="ActivaRiesgo">Activar</button>
                  </form>
