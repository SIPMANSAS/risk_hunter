            ...
            <div class="navbar-header">
              ...
              <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
               <ul class="nav navbar-nav">
                   <li class="flat-box"><a href="http://192.168.0.250/puntoventa/index2.php"> <img src="files/Setting/logohorosnegro.png" alt="horos"  style='max-height: 45px; max-width: 200px;margin-top:5px;'> <span class="menu-text"> Retornar </span></a></li>
