...
// Se buscan reservas creadas
        	...
        	echo'
            <form class="buscar" action="buscar_checkout.php" method="post">
	               ...
	               while($XROWRES=$XOBJRES->obtener_fila($XRSRES)){
		             ...
		             $calnav = $calnav;
                        ...
                        $calnav = $calnav.'
                            ...
                            <a href="buscar_checkout.php?idhab='.$idhab.'&fecha=1" >
            ...
            //       $color = $XROWRES[9];
             ...
             //	$XCODIGO=retornar_codigo(10,$XROWRES[0]);
				...
				echo'<tr style="background-color:'.$color.'">
    	        	<td class="Txtmenu"><a onclick="PrcEncontrarcheckin('.$cedula.','.$numhab.')" style="cursor:pointer">
						'.$XROWRES[0].'
					</td>
        	    	<td class="Txtmenu"><a onclick="PrcEncontrarcheckin('.$cedula.','.$numhab.')" style="cursor:pointer">
						'.$XROWRES[1].'</a>
                  ...
                  echo '<td> <a class="checkin-img" onclick="PrcEncontrarcheckin('.$cedula.','.$numhab.')" style="cursor:pointer"><img src="assets/images/checkin.png" alt=""></a></td>
        	   	</td></tr>';
        	   	$XNUMFILA++;
        	//   	$xi++;
              	}
