...
// Se buscan reservas creadas
        	...
        	echo'
            <form class="buscar" action="buscar_checkoutoficial.php" method="post">
                <h1>Buscar Historial de Checkout </h1>
	               ...
	               while($XROWRES=$XOBJRES->obtener_fila($XRSRES)){
		             ...
		             $calnav = $calnav;
                        ...
                        $calnav = $calnav.'
                            ...
                            <a href="buscar_checkoutoficial.php?idhab='.$idhab.'&fecha=1" >
