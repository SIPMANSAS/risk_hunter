...
function FncBuscarseq($XSEQUENCIA,$parametro,$filtro) {
           ...
           $XNEXTSEQ=$XOBJRES->obtener_fila($XROWSEQUENCIA);
             ...
             fwrite($ddf,"[".date("r")."] Error revisa consulta $XSELECT  secuencia es $XNEXTSEQ \r\n");
             fclose($ddf);
...
if(!empty($_POST["guardar"])) {
   ...
   echo "estoy en guardar idhab $idhab";
   if (($setid != "" ) && ( $_POST["entrada"] != "") && ($_POST['salida1'] != "") && $cedula1 != "" && $cedula1 != "0" && $idhab != "")
    {

       echo "entre a tiene cedula y habitacion";
        $flaq = 1;
       $secuencia="";
       $mens = "";
       $correcto = "true";
        ...
        if ($correcto == "true")
        {
           ...
           if((!isset($XRSPRE)) or ($XRSPRE == FALSE)) {
              ...
              $mensaje = "Se ha presentado error en la creación de la reserva... ".$XRSPRE;
                ...
                echo "voy a ingresar detalle de la reserva";
                 $XINFODETR[0] = $setid;
           ...
           // inserto el detalle de la forma de pago del cliente
                 ...
                 {
                      echo " voy a insertar en la tabla calendar data ududufuf";
		 ...
		 // ingreso el acompañante en la tabla de tercero  y tabla clientes
                   ...
                   if ($flq == "0") {
                       echo "voy a ingresar clientes en zarest";
                        $cedula = trim($_POST['cedula1']);
                 ...
                 if (isset($XROWHAB1[0]))
                  ...
                  echo "voy a ingresar en sales el valor del alojamiento";
...
?>
    ...
    <div class="op-b">
       ...
       <input type="text" name="amount" value="<?php echo $tarifa; ?>" maxlength="12">   </span>
    </div>
    <div class="op-b">
        <label for="deposit"> Abono </label>
		<span class="input-group-text"> $
        <input type="text" name="deposit" value="<?php echo $abono; ?>" maxlength="12">  </span>
    </div>
    <div class="op-b">
        <label for="balancedue"> Saldo </label>
	    <span class="input-group-text"> $
        <input type="text" name="balancedue" value="<?php echo $saldo; ?>" maxlength="12">  </span>
    </div>
    <div class="op-b">
        <label for="impuestos"> Impuestos </label>
	    <span class="input-group-text"> $
        <input type="text" name="impuestos" value="<?php echo $impuesto; ?>" maxlength="12"> </span>
    </div>
  </div>
<div class="viaje">
   <div>
