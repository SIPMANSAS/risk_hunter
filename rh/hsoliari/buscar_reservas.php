...
<head>
  ...
  <title>Gestion de Reservas </title>
     ...
     <link href="https://file.myfontastic.com/9BSJsJXeZj4Niw93oc7veK/icons.css" rel="stylesheet">
                ...
                <div class="rango">
                    <div>
                        ...
                        <SELECT id="idstatus" name="idstatus">';
                            ...
                            $filtro = "where status not in ('checkin','checkinpagado','checkintotalpagado','checkout')";
	               ...
	               while($XROWRES=$XOBJRES->obtener_fila($XRSRES)){
		             ...
		             $calnav = $calnav;
                        ...
                        $calnav = $calnav.'
                            ...
                            <a href="buscar_reservas.php?idhab='.$idhab.'" >
		...
		$postdesde = $_POST['fechadesde'];
	     ...
	     $total_paginas = ceil($num_total_registros / $TAMANO_PAGINA);
            ...
            if ($total_paginas > 1) {
             if ($pagina != 1) {
                ...
                $pagant = $pagina - 1;
                    ...
                    <img src='assets/images/izq.png' border='0'> Anterior </a></li>";
               }
            ...
            if ($pagina != $total_paginas)  {
               $pagnext = $pagina + 1;
                echo '<li class="next">';
                 echo "<a href='buscar_reservas.php?pagina=$pagnext'> Siguiente <img src='assets/images/der.png'></a></li>";
              }
            }
            echo "</ul></caption>";
                 $XNUMFILA = 0;
            ...
            if ($xi < $tampag) {
            //   if ($XNUMFILA%2==0)
                   //      $color = "#ffcc33"; //si el resto de la divisi�n es 0 pongo un color
                   $color = $XROWRES[9];
             //  else
      	       //          $color = "#33658a";
