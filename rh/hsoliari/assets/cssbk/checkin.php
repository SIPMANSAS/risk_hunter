   ...
   if (($setid != "" ) && ( $_POST["entrada"] != "") && ($_POST['salida1'] != "") && $cedula1 != "" && $cedula1 != "0" && $idhab != "")
    {
       ...
       $XRSTER=$XOBJRES->ingresar_tercero($XINFOTER);
        ...
        if ($correcto == "true")
        {
	        ...
	        $XINFOPRE[6] = $nino;
	        $XINFOPRE[7] = "1";
	        $XINFOPRE[8] = (int)$_POST['totalreserva'];
        ...
        $sqlter = $querytercero.$queryValueter;
         ...
         if (!isset($idreserva))
          ...
          <li class="btn-action"><a class="btn btn-primary" onclick="Prcprint('.$numres.')"
...
?>
  ...
  <FORM name="frmProduct" method="post" action="checkin.php" id="checkin">
    ...
    <div class="mt-5">
    Fecha <?php $fechareserva ?> <h3> Detalles de la Reserva No. <?php  $XNUMRES ?> </h3>         <p> <label style="width:100%" for="status"> Estado Reserva </label>
    ...
    <div >
       ...
       <div >
        ...
        <div>
           ...
           <input name="entrada" type="text" size=10 id="datepicker1" value=" <?php $XROWRES[5] ?> " required>
        </div>
        <div>
            <label for="salida">Fecha Salida</label>
            <input type="text" size=10 name="salida1" maxlength="12" id="datepicker2" value=" <?php echo $salida1;  ?>" required >
        </div>
        <div>
            <label for="salida">Noches</label>
           <input type="text" size=10 name="noches" maxlength="12" id="noches" value= "<?php echo $noches; ?>" readonly required>
 ...
 <div class="op-b">
            ...
            <div class="referido">
                ...
                <div>
                  <div>
                   ...
                   <div>
                       ...
                       <input type="checkbox" name="parqueader" value="1" > Parqueadero
                       </div>
                ...
                <div>
                        ...
                        <div><input type="text" name="tercero" id="idtercero" value = "<?php echo $idtercero1; ?> " maxlength="5" readonly >
                         <input type="text" name="pax" id="pax" value = "<?php echo $pax1; ?> " maxlength="5" readonly ></div>
                        </div>
...
$tiha = $tiha .'
    ...
    <div class="op-b">
	    ...
	    <span class="input-group-text"> $
        <input type="text" name="totalreserva" id="totalreserva" value=" '. $totalreserva .'" maxlength="12" readonly>  </span>
    </div>
    <div class="op-b">
