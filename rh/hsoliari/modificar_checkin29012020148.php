...
<a href=""></a>
         ...
         //   $xi = $inicio;
          ...
          //  if ($xi < $tampag) {
              if ($XNUMFILA%2==0)
                         $color = "#ffcc33"; //si el resto de la división es 0 pongo un color
            //       $color = $XROWRES[9];
              else
      	                $color = "#33658a";
             //	$XCODIGO=retornar_codigo(10,$XROWRES[0]);
				...
				echo'<tr style="background-color:'.$color.'">
                  ...
                  echo '<td> <a class="checkin-img" onclick="PrcEncontrarcheckout('.$XCODIGO.','.$statusid.','.$numhab.')" style="cursor:pointer"><img src="assets/images/checkout.jpg" alt=""></a></td>
        	   	</td> ';
                   echo '<td> <a class="checkin-img" onclick="PrcEncontrarReservamodifica('.$XCODIGO.','.$statusid.','.$numhab.')" style="cursor:pointer"><img src="assets/images/modificar.jpg"  alt=""></a></td>
        	   	</td> ';
                   echo '<td> <a class="checkin-img" onclick="Prcprint('.$XCODIGO.')" style="cursor:pointer"><img src="assets/images/imprimir.png"  alt=""></a></td>
        	   	</td> ';
                   echo '<td style="background-color:#ffcc33"> <a class="checkin-img" onclick="PrcEncontrarReservamodifica('.$XCODIGO.','.$statusid.','.$numhab.')" style="cursor:pointer"><img src="assets/images/pago.png"  alt=""></a></td>
        	   	</td> ';
