        ...
        $sqlter = $querytercero.$queryValueter;
         ...
         if($ProContador!=0) {
          ...
          <div class="detalle">
           ...
           $disp = $disp . '      <div class="btn-action float-clear">
              <div id="div_file">
                <p id="textofile">Subir Firma</p>
            <input class="btn btn-primary" type="file" id="btn_firmar" name="subir_firma" onClick="BorrarRegistro();" />
             </div>
             <input class="btn btn-success" type="button" name="imprimir" value="Imprimir Checkin" onClick="imprimir();" />
           </div>
...
?>
         ...
         <span class="input-group-text">
          ...
          <div>
            ...
            <textarea name="note_en" rows="6" class="form-control" type="text" >
