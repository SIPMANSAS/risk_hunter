...
function FncBuscarseq1($XSEQUENCIA,$parametro,$filtro) {
           $XSELECT = "select * from $XSEQUENCIA order by $parametro desc limit 1";
           $XOBJRES=new greservas;
           $XROWSEQUENCIA = $XOBJRES->FncBuscarSequencia($XSELECT);
           $XNEXTSEQ=$XOBJRES->obtener_fila($XROWSEQUENCIA);
           return $XNEXTSEQ[0];
        ...
        if ($correcto == "true")
        {
            ...
            $numnoches = restar_fechas($_POST['entrada'] , $_POST['salida1']);
             if ($numnoches == 0)
               $numnoches = 1;
            $origen = "ERP";
            $adult = intval($_POST['guestadult']);
            $nino = intval($_POST['guestchild']);
           ...
           if((!isset($XRSPRE)) or ($XRSPRE == FALSE)) {
              ...
              $mensaje = "Se ha presentado error en la creación de la reserva... ".$XRSPRE;
                ...
                // inserto el detalle de la reserva  en tbl_det_reserva
                 ...
                 $XINFODETABONO[4] = (int)$_POST['amount'];
                 $basepago = (int)$_POST['deposit'] - (int)$_POST['impuestos'];
                 $XINFODETABONO[5] = $basepago;
                 $XINFODETABONO[6] = (int)$_POST['impuestos'];
                 $XINFODETABONO[7] = $idcliente;
                 $XINFODETABONO[8] = $idtercero;
                 $XINFODETABONO[9] = (int)$_POST['balancedue'];
                 $XINFODETABONO[10] = (int)$_POST['deposit'];
         ...
         /*
                 ...
                 $XINFODETSALE[2] = $_POST['impuestos'];
                 $basepago = $_POST['amount'] - $_POST['impuestos'];
                 $saldo = $_POST['amount'] - $_POST['deposit'];
                 $XINFODETSALE[3] = $basepago;
                 $XINFODETSALE[4] = $_POST['amount'];
                 $XINFODETSALE[5] = $saldo;
                 $XINFODETSALE[6] = "1";
                 $XINFODETSALE[7] = $_POST['deposit'];
                 $XINFODETSALE[8] = "2~".$_POST['numhab'];
                 $XINFODETSALE[9] = "admin";
                 $XINFODETSALE[10] = "1";
...
<FORM name="frmProduct" method="post" action="checkin.php">
    <div class="contenedor">
        ...
        Fecha 
        <?php echo $XROWRES[7]; ?>
        <h3> Detalles de la Reserva No. <?php echo $XNUMRES; ?> </h3><hr>
        <div class="viaje">
            <div>
            ...
            <div>
                ...
                <input type="text" name="guestadult"  placeholder=" <?php echo $adult; ?> " >
            </div>
            <div>
                <label for="guestchild"> Menores &nbsp;&nbsp;</label>
                <input type="text" name="guestchild" placeholder" <?php echo $ninno; ?> " >
            </div>
        </div>
        <div class="viaje">
            <?php
            ...
            <div class="mt-6">
                ...
                <div class="viaje">
                    ...
                    <div class="op-b">
                       ...
                       <?php echo $tarifa;?>  </span>
                    </div>
                    <div class="op-b">
                        <label for="tarifa-m">Tarifa manual</label>
                        <input type="text" >
                    </div>
                    <div class="op-b">
