...
<title><?php echo "TRIPPHOST" ?></title>
<meta name="author" content="transinova.com">
<link href="assets/css/bootstrap.min.css" rel="stylesheet">
<link href="assets/css/app.css" rel="stylesheet">
<link href="assets/css/calendartrip.css" rel="stylesheet">
...
<nav class="navbar navbar-expand-lg navbar-light fixed-top calapp">
  <div class="container">
<a class="navbar-brand" href="index2.php"><img src="<?php echo SITEURL."assets/images/logotripstercuadrado.png"?>" alt="<?php echo $gist->pptname ?>"></a>
...
?>        
        ...
        aria-haspopup="true" aria-expanded="false"><?php echo "Publicar Experiencias" ?> <span class="caret"></span></a>
          <div class="dropdown-menu">
<a class="dropdown-item" href="users.php"><?php echo "Publicar Experiencias" ?></a>
<a class="dropdown-item" href="users.php?do=assign"><?php echo Lang::$say->_UR_ASSIGNMENT;?></a>        
        ...
        aria-haspopup="true" aria-expanded="false"><?php echo "Ayudas" ?> <span class="caret"></span></a>
          <div class="dropdown-menu">
<a class="dropdown-item" href="settings.php"><?php echo "Modulo Motivacional" ?></a>
<a class="dropdown-item" href="settings.php"><?php echo "Paso a Paso para publicar experiencias" ?></a>
...
data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><?php echo "Perfil TrippHost" ?> <span class="caret"></span></a>
          <div class="dropdown-menu dropdown-menu-right">
            <a class="dropdown-item" href="account.php"><?php echo "TrippHost Juliana Perez" ?></a>
            <a class="dropdown-item" href="account.php?do=links"><?php echo "TrippHost" ?></a>
