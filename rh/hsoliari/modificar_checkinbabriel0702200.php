...
<a href=""></a>
         ...
         //   $xi = $inicio;
          ...
          //  if ($xi < $tampag) {
              if ($XNUMFILA%2==0)
                         $color = "#33658a"; //si el resto de la división es 0 pongo un color
            //       $color = $XROWRES[9];
              else
      	                $color = "#33658a";
             //	$XCODIGO=retornar_codigo(10,$XROWRES[0]);
				...
				echo'<tr style="background-color:'.$color.'">
                  ...
                  echo '<td> <a class="checkin-img" onclick="PrcCHECKOUT('.$cedula.','.$numhab.')" style="cursor:pointer"><img src="assets/images/checkout.png" alt=""></a></td>
        	   	</td> ';
                   ...
                   echo '<td style="background-color:#ffcc33"> <a class="checkin-img" onclick="PrcPAGOS('.$cedula.','.$numhab.')" style="cursor:pointer"><img src="assets/images/pago.png"  alt=""></a></td>
        	   	</td> ';
