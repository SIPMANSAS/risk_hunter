...
if ((isset ($_POST["adult"])) && (isset($_POST["ninno"])) )
{
   $adult = $_POST["adult"];
   $ninno = $_POST["ninno"];
}
...
?>
 ...
 <div class="op-b">
     ...
     <hr>
      ...
      <div class="radio">
<?php
    echo 'pax es: <span id="resultado">' .$pax1 .'</span>';
    echo 'pax1 es ' . $pax1;
if (isset($_POST["pax1"]))
{
         echo 'pax1 es ' . $pax1;
     $XHAB=$XOBJRES->buscar_habcalendar($pax1);
     while($XHABRES=$XOBJRES->obtener_fila($XHAB))
     {
       if($XHABRES[1] == $numhab)
       {
            echo '<div><img src="'.$XHABRES[4].'">
