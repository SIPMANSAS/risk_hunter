<?php
   ...
   * @copyright 2017-2018
   * @version $Id: class.sift.php, v1.1.0 Feb 2018 transinova $
   */
...
if($closable){$opentag='<div class="alert alert-warning alert-dismissible" role="alert">
  <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>';}else{$opentag='<div class="alert alert-warning" role="alert">';}		  
  ...
  <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>';}else{$opentag='<div class="alert alert-success" role="alert">';}
...
if($closable){$opentag='<div class="alert alert-danger alert-dismissible" role="alert">
  <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>';}else{$opentag='<div class="alert alert-danger" role="alert">';}		  
  ...
  <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>' . $msg . '</div>';
      ...
      {
          self::$showMsg = '<div class="alert alert-danger alert-dismissible" role="alert">
  <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button><div class="header">' . Lang::$say->_SYSTEM_ERR . '</div><div class="content"><ul class="wenbs list">';
