     ...
     <div id="sugerencia"></div>
        ...
        <div class=" titulo"><b>Acciones</b></div>
          ...
          <?php
            ...
            $consultacompanias = $bloques->consultacompaniasactivas();
            ...
            <div class="contenedor">
              <div class="campos_f">
                  <form action="vercompaniaseguros.php" id="form" method="POST">
                      ...
                      <input type="hidden" name="idusuario" id="idusuario" value="<?php echo $extraerDatos['identificacion'] ?>">
                  </form>
              </div>
              <div class="campos_f"><?php echo $extraerDatos['nombres']; ?></div>
              <div class="campos_f"><?php echo $extraerDatos['id_alfanumerico'].'-'.$extraerDatos['numero_identificacion']; ?></div>
                ...
                <div class="campos_f">
                  ...
                  <form action="controller/controllerFirmas.php" method="POST">
                   ...
                   <form action="asignarfirmainspectora.php" method="POST">
                      <input type="hidden" value="<?php echo $extraerDatos['identificacion'];  ?>" name="id">
                      <input  type="hidden" value="<?php echo $extraerDatos['nombres'];  ?>" name="nombrefirma">
                      <button class="btn_verde" type="submit">Selecciónar Firma Inspectora</button>
                  </form>
               </div>
            </div>   
          <?php
