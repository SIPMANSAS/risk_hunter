...
?>
        ...
        <div class="inputs_r">
          ...
          <input class="inp_med" type='text' placeholder="Ingrese Número Contacto Inspector" name="contactoinspector" disabled>
        </div>
        <div class="inputs_r">
            <label>Fecha Inspección:</label>
            <input class="inp_med" type='date' name='fechaInspeccion' value="<?php echo $fecha_inspe_fin ?> " max="" min="<?php echo $fechaFinal;?>" disabled>
