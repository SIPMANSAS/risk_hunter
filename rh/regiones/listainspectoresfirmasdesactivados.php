    ...
    if(isset($_POST["identificau"]) or (isset($_POST["idusuario"])))
    {
        ...
        <div class="titulo_p">
            <center><i class="fa-solid fa-user"></i> INSPECTORES FIRMAS INSEPCTORAS INACTIVOS</center>
        </div>
        
        <div class="link_int"><div class="titulo2"><i class="fa-solid fa-list"></i><a href="listainspectoresfirmas.php"> Listar Inspectores Firmas Inspectoras Activos</a></div>
     ...
     <div id="sugerencia"></div>
        ...
        ?>
          ...
          <?php
            ...
            $consultainspectoresfirmas = $bloques->consultainspectoresfirmainspectorainactivos();
          ...
          ?>
            <div class="contenedor">
                ...
                <div class="campos_f">
                    <?php echo $extraerDatos['vdom_tipo_identificacion'].'-'.$extraerDatos['numidentificacion']; ?>
                </div>
                <div class="campos_f">
              ...
              <div class="campos_f">
                ...
                <div class="campos_f">
                  ...
                  <form action="controller/controllerFirmas.php" method="POST">
                     <input type="hidden" name="id" id="ident" value="<?php echo $extraerDatos['identificador'] ?>">
                      <button class="btn_rojo" type="submit" name="activarinspectorfirmainspectora">Activar</button>
                  </form>
               </div>
              </div>
            </div> 
