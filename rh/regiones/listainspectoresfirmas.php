    ...
    <head>
        ...
        <title>Inspectores Firmas Inspectoras</title>
    ...
    if(isset($_POST["identificau"]) or (isset($_POST["idusuario"])))
    {
        ...
        <div class="titulo_p">
            <center><i class="fa-solid fa-user"></i> INSPECTORES FIRMAS INSPECTORAS ACTIVOS</center>
        </div>
        
        <div class="link_int"><div class="titulo2"><i class="fa-solid fa-list"></i><a href="listainspectoresfirmasdesactivados.php"> Listar Inspectores Firmas Inspectoras Desactivados</a></div>
        <div class="titulo3"><i class="fa-solid fa-plus"></i><a href="crearinspectorfirmainspectora.php"> Crear Inspector de Firma Inspectora</a></div></div>
     ...
     <div id="sugerencia"></div>
        ...
        ?>
          ...
          <?php
            ...
            $consultainspectoresfirmas = $bloques->consultainspectoresfirmainspectora();
            while ($extraerDatos =  $bloques->obtener_fila($consultainspectoresfirmas)){
          ?>
            <div class="contenedor">
                <div class="campos_f">
                  <form action="verinspectorindependiente.php" id="form" method="POST">
                      ...
                      <input  type="hidden" value="<?php echo $extraerDatos['vdom_tipo_identificacion'];?>" name="tipdocletra"?>
                ...
                <div class="campos_f">
                    <?php echo $extraerDatos['numidentificacion']; //echo $extraerDatos['id_alfanumerico'].'-'. ?>
                </div>
                <div class="campos_f">
              ...
              <div class="campos_f">
                ...
                <div class="campos_f">
                  <form action="editarinspectorfirmas.php" method="POST">
                      <input  type="hidden" value="<?php echo $extraerDatos['nombre'];  ?>" name="nombreinspector">
                      <input  type="hidden" value="<?php echo $extraerDatos['apellidos'];  ?>" name="apellidoInspector">
                      <input  type="hidden" value="<?php echo $extraerDatos['vdom_tipo_identificacion'];  ?>" name="tipodocumento">
                  ...
                  <form action="controller/controllerFirmas.php" method="POST">
                     <input type="hidden" name="id" id="ident" value="<?php echo $extraerDatos['identificador'] ?>">
                      <button class="btn_rojo" type="submit" name="desactivarinspectorfirmainspectora">Desactivar</button>
                  </form>
               </div>
              </div>
            </div> 
