...
if(isset($_POST["identificau"]) or (isset($_POST["idusuario"])))
{
    ...
    echo '<div class="link_int"><div class="titulo2"><i class="fa-solid fa-user"></i><a href=""> Consultar Usuarios</a> / </div>
<div class="titulo3"><a href="registro1.php?id='.$identificador.'">Crear Usuario</a></div></div>';
    
    echo '<div class="contenedor_titulos">
    <div class=" titulo_list_u">ID</div>
    <div class=" titulo_list_u">Email</div>
    <div class=" titulo_list_u">Nombre Completo</div>
...
{
echo '<form id="form" action="listausuarios.php" method="POST">';
echo '<div class="link_int"><div class="titulo2"><i class="fa-solid fa-user"></i><a href=""> Consultar Usuarios</a> / </div>
<div class="titulo3"><a href="registro1.php?id=$identificador">Crear Usuario</a></div></div>';
echo '<div class="titulo_s">';
