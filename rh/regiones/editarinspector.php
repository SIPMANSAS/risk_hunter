...
<div class="titulo_p"><i class="fa-solid fa-file-pen"></i> Editar Inspector Independiente</div>
<div class="link_int">
...
?>
    ...
    <div class="inputs_r">
      <input type='submit' class="btn_azul" name="editarinspectorindependiente" value="Editar">
    </div>
  </form>
