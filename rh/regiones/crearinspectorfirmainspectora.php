...
?>
<head>
  <title>Registro Inspectores Firma Inspectora</title>
...
<body>
  ...
  <div class="titulo_p"><i class="fa-solid fa-file-pen"></i> REGISTRO INSPECTORES FIRMA INSPECTORA</div>
  <div class="link_int">
      <div class="titulo2">  <a href="listainspectoresfirmas.php">+Listar Inspectores Firma Inspectora</a></div>
    </div>
    <div class="contenedor_titulos">
      <div class="titulo">Inspectores Firma Inspectora</div>
    </div>
...
?>
    <div class="inputs_r">
      <input class="btn_azul" type='submit' name="registrarinspectorfirmainspectora" value="Guardar">
    </div>
  </form>
