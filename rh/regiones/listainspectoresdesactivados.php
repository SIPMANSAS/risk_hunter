    ...
    <head>
        ...
        <title>Inspectores Independientes Inactivos</title>
    ...
    if(isset($_POST["identificau"]) or (isset($_POST["idusuario"])))
    {
        ...
        <div class="titulo_p">
            <center><i class="fa-solid fa-user"></i> INSPECTORES INDEPENDIENTES DESACTIVADOS</center>
        </div>
        
        <div class="link_int"><div class="titulo2"><i class="fa-solid fa-list"></i><a href="listainspectoresindependientes.php"> Listar Inspectores Activos</a></div>
        <div class="titulo3"><i class="fa-solid fa-plus"></i><a href="registroinspectoresindependientes.php"> Crear Inspector Independiente</a></div></div>
          ...
          <?php
            ...
            $consultainspectoresindpendientesinactivos = $bloques->consultainspectoresindependientesinactivos();
            while ($extraerDatos =  $bloques->obtener_fila($consultainspectoresindpendientesinactivos)){
          ?>
              ...
              <div class="campos_f">
                ...
                <div class="campos_f">
                  <form action="controller/controllerFirmas.php" method="POST">
                     <input type="hidden" name="id" id="ident" value="<?php echo $extraerDatos['identificador'] ?>">
                      <button class="btn_verde" type="submit" name="activarinspectorindependiente">Activar</button>
                  </form>
               </div>
              </div>
            </div> 
