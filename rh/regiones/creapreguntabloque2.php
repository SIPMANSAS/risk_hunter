...
function AgregarMas() {
    ...
    $("<div>").load("InputDinamicoPreguntas2.php", function() {
            var html = $(this).html();
...
{   
    ...
    echo '
                        ...
                        <div class="titulo2"><i class="fa-solid fa-question"></i><a href="creapreguntabloque.php"> Nuevo Bloque de Preguntas</a></div>
