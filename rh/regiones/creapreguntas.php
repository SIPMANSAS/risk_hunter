...
<head>
    ...
    <link rel="stylesheet" href="css/regiones2.css">
...

        {
           ...
           /* Recorro el numero de preguntas padres creadas y las inserto */
            ...
            {     
                ...
                <div class="float-left col-heading2"> Es Pregunta Padre?</div>

                <div class="float-left col-heading2"> Padre</div>

                <div class="float-left col-heading2"> Tipo Estado</div>

                <div class="float-left col-heading2"> Estado</div>
...
?>
                ...
                <h3>Preguntas que pertenecen al Bloque </h3>
                ...
                <div class="float-left col-heading2"> Tipo Estado Estado</div>  
...
<center><input class="btn btn-primary" type="submit" name="guardar" value="Guardar Ahora" /></div></div></center>
...
<a  class="btn_rojo"href="">prueba</a>
</html>