    ...
    if(isset($_POST["identificau"]) or (isset($_POST["idusuario"])))
    {
        ...
        ?>
          <div class="contenedor_titulos">
            <div class=" titulo">Bloque Pregunta</div>
          ...
          <?php
            ...
            $consultasabana = $bloques->consultadetalleinspeccion($id_encuesta,$identificador);//$id_menu_p
    
            while ($extraerDatos =  $bloques->obtener_fila($consultasabana)){
                $bloque_pregunta = $extraerDatos['bloque_pregunta'];
                $pregunta = $extraerDatos['pregunta'];
                $respuesta = $extraerDatos['respuesta_texto'];
