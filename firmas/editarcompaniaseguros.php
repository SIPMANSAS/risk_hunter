...
<div class="contenedor">
 <form class='registro' action="controller/controllerFirmas.php" method="POST">
        ...
        $idFir = $_POST['idFirma'];
        $ConsultaDatos = $mysqli->query("SELECT * FROM ter_terceros F JOIN rg_paises P ON F.pais = P.codigo JOIN rg_departamentos D ON F.departamento = D.codigo JOIN rg_ciudades C ON F.ciudad = C.codigo WHERE F.tipoCliente = 0 AND  vdom_tipo_tercero='772' AND F.estado=1 AND identificacion = '$idFir'");
