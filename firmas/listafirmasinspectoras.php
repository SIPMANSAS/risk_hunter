    ...
    $(document).ready(function() {
    	...
    	$.ajax({
                type: "POST",
                url: "funcionessebastian/obtienesearchfirmas.php",
                data: parametros,
    ...
    if(isset($_POST["identificau"]) or (isset($_POST["idusuario"])))
    {
        ...
        <div class="link_int"><div class="titulo2"><i class="fa-solid fa-list"></i><a href="listarfirmasdesactivadas.php"> Listar Firmas Inspectoras Desactivadas</a></div>
     ...
     <div id="sugerencia"></div>
        ...
        ?>
          ...
          $ConsultaDatos = $mysqli->query("SELECT * FROM ter_terceros F LEFT JOIN rg_paises P ON F.pais = P.codigo JOIN rg_departamentos D ON F.departamento = D.codigo JOIN rg_ciudades C ON F.ciudad = C.codigo WHERE F.estado=1 AND F.tipoCliente=0 AND vdom_tipo_tercero='774' GROUP BY identificacion ASC");
