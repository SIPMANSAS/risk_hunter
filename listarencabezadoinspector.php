    ...
    if(isset($_POST["identificau"]) or (isset($_POST["idusuario"])))
    {
        ...
        <?php
        /*
        <div class="titulo2"><i class="fa-solid fa-download"></i><a Onclick="window.location='exportacion/exportarencabezadoinspector.php'"> Exportar Listado Inspecciones Inspector</a>
        */
        ?>
     ...
     <div id="sugerencia"></div>
          ...
          ?>
            <div class="contenedor">
                <div class="campos_f">
                    <div class="campos_list_u">
                        <input type="submit"  class="btn_sel" name="ident" id="identificau" value="<?php echo $extraerDatos['identificador'] ?>" >
                    </div>
                </div>
                <div class="campos_f">
                ...
                <div class="campos_f">
                  <form action="editarencabezadoinspector.php"  method="POST">
                      ...
                      <input  type="hidden" value="<?php echo $extraerDatos['id_ciudad'];  ?>" name="ciudad_id">
                      ...
                      <input  type="hidden" value="<?php echo $extraerDatos['lista_biene'];  ?>" name="lista_bienes">
                      <input  type="hidden" value="<?php echo $extraerDatos['bienes_inspeccionar'];  ?>" name="bien_inspeccionar">
                      <input  type="hidden" value="<?php echo $extraerDatos['fecha_inspeccion'];  ?>" name="fecha_inspeccion">
    ...
    <?php 
          ...
          <?php
            ...
            $bloques    = new bloques;
            $consulta = $bloques->iniciarVariables();
            $consultaencabezado = $bloques->consultaencabezadoinspectorfree();
            while ($extraerDatos =  $bloques->obtener_fila($consultaencabezado)){
          ?>
            <div class="contenedor">
                <div class="campos_f">
