    ...
    if(isset($_POST["identificau"]) or (isset($_POST["idusuario"])))
    {
        ...
        <div class="link_int">
            <div class="titulo2"><i class="fa-solid fa-list"></i><a href="listarfirmasdesactivadas.php"> Listar Firmas Inspectoras Bloqueadas</a></div>
            <div class="titulo3"><i class="fa-solid fa-plus"></i><a href="registrofirmasinspectoras.php"> Crear Firma Inspectora</a></div>
        </div>
