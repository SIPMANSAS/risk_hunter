...
<tbody>';
    ...
    $tabla .= "<tr>";
    $tabla .= "";
    /////////////////////////// END PINTA LOS TITULOS MAS EXTERNOS DE LA MATRIZ ARRIBA /////////////////////////  colspan='1' rowspan='$textoC'
    ...
    $tabla .= "<td class='verticalText' style='background-color:#00E0FF;width: 50px;height: 150px;'>
                <h3>
