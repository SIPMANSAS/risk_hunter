...
//	include_once("clases/utidatos.class.php");
  ...
  if (isset($_POST['key']) && ($_POST['key'] <> "")) 
  {
       ...
       while ($xrowproyectos = $Json->obtener_fila($xcompproyectos)) {
           ...
           $html .= '<div><a class="sugerencia-element" data="'.utf8_encode($xrowproyectos['nombre']).'" id="'.$xrowproyectos['identificador'].'">'.$xrowproyectos['identificador']."-".($xrowproyectos['nombre']).'</a></div>';
        }
       echo $html;
  }
