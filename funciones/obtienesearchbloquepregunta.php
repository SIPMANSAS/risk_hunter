...
//	include_once("clases/utidatos.class.php");
  ...
  if (isset($_POST['search']) && ($_POST['search'] <> "")) 
  {
       ...
       while ($xrowproyectos = $Json->obtener_fila($xcompproyectos)) {
           ...
           $html .= '<div><a class="sugerencia-element" data="'.($xrowproyectos['descripcion']).'" id="'.$xrowproyectos['identificador'].'">'.$xrowproyectos['identificador']."-".($xrowproyectos['descripcion']).'</a></div>';
        }
       echo $html;
  }
