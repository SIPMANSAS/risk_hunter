    ...
    if(isset($_POST["identificau"]) or (isset($_POST["idusuario"])))
    {
        ...
        $consultainspeccionesfreemium = $mysqli->query("SELECT * FROM enc_inspeccion WHERE id_usuario = '$id_usuario_ext' AND origen = 'FR'");
        ?>
   
        <div class="titulo_p">
            <center><i class="fa-solid fa-user"></i>INSPECCIONES FREEMIUM </center>
        </div>
        <?php
        /*
        ...
        ?>
            ...
            <div class="titulo3">
                <form action="controller/controllerencabezado.php" method="POST">
                    <input type="hidden" value="<?php echo $id_usuario_ext?>" name="id_usuario_ins">
                    <i class="fa-solid fa-plus"></i><button type="submit" name="nuevainspeccionfreemium"> Nueva Inspección</a>
                </form>
            </div>
        </div>
     ...
     <div id="sugerencia"></div>
        ...
        ?>
          <div class="contenedor_titulos">
            ...
            <div class=" titulo">Nombre Solicitante</div>
          ...
          <?php
            ...
            $id_menu_p;
            //echo "SELECT * FROM enc_inspeccion WHERE id_usuario = '$id_usuario_ext'";
            $consultainspeccionesfreemium = $mysqli->query("SELECT * FROM enc_inspeccion WHERE id_usuario = '$id_usuario_ext' AND origen = 'FR'");
            while($extraerDatos = $consultainspeccionesfreemium->fetch_array()){
            ...
            while($extraerDatosClientes = $consultacias->fetch_array()){
                ...
                <div class="campos_f">
                  <?php echo $extraerDatos['nombre_solicita']; ?>
                </div>
                <div class="campos_f">
                  <?php echo $extraerDatos['fecha_solicitud'].'</div>'; /*?>
                </div>
                 <div class="campos_f">
                ...
                */
                ...
                ?>
                    <div class="campos_f">
                        <form action="verencabezadofreemium.php" method="POST">
                            <input  type="hidden" value="<?php echo $extraerDatos['numero_inspeccion'] ?>" name="inspeccion">
                            <input  type="hidden" value="<?php echo $extraerDatos['identificador'];  ?>" name="identificador">
                            <input  type="hidden" value="<?php echo $extraerDatos['fecha_solicitud'];  ?>" name="fechasolicitud">
                            <input  type="hidden" value="<?php echo $extraerDatos['descripcion'];?>" name="descripcion"?>
