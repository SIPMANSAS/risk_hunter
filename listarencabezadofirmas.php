        ...
        ?>
          ...
          <?php
            ...
            while ($extraerDatos =  $bloques->obtener_fila($consultaencfirmas)){
                ...
                $oficinacia = $extraerDatos['id_oficina_cia_seguros'];
                $idbienesinsp = $extraerDatos['id_bienes'];
                $idinspector = $extraerDatos['id_inspector'];
                $telefonoins = $extraerDatos['numero_telefono'];
            ...
            <div class="contenedor">
                    <form action="verinspeccionfirmas.php" id="form"  method="POST">
                        ...
                        <input  type="hidden" value="<?php echo $oficinacia ?>" name="id_oficina_cia">
                        <input  type="hidden" value="<?php echo $idbienesinsp ?>" name="id_bienes">
                        <input type="hidden" value="<?php echo $telefonoins ?>" name="telefono_ins">
                     </form>
                      <div class="campos_f">
                    <?php 
                ...
                <?php
                if($rolxusuario == 1 || $rolxusuario == 2 || $rolxusuario == 5){
                ?>
                <div class="campos_f">
                     <form action="editarencabezado.php" method="POST">
                        ...
                        <input  type="hidden" value="<?php echo $idbienesinsp ?>" name="id_bienes">
                        <input type="hidden" value="<?php echo $telefonoins ?>" name="telefono_ins">
                        <input type="hidden" value="<?php echo $identificador?>" name="ref_inspeccion">
                     ...
                     <form action="verinspeccionfirmas.php" method="POST">
                        ...
                        <input  type="hidden" value="<?php echo $fecha_posible_inspeccion;  ?>" name="fecha_posible_inspeccion">
                         <input  type="hidden" value="<?php echo $idbienesinsp ?>" name="id_bienes">
                          <input  type="hidden" value="<?php echo $inspectorasignado ?>" name="nombre_inspector">
                          <input  type="hidden" value="<?php echo $idinspector ?>" name="id_inspectorB">
                          <input type="hidden" value="<?php echo $telefonoins ?>" name="telefono_ins">
