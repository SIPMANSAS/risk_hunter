  ...
  <div class="contenedor">
    <form class="registro" action="controller/controlleBienes.php" method="POST">
        <div class="inputs_r">
            ...
            <input type="text" class="inp_med" id="longitud" name="longitud" >
        </div>
        <div class="inputs_r">
            <label>Latitud:</label>
            <input type="text" class="inp_med" id="latitud" name="latitud" >
        </div>
        <div class="inputs_r">
            <label>Estrato:</label>
            <?php
            ...
            ?>
            <select type="text" id="estrato" name="estrato" onkeyup="PasaValor();" required>
       ...
       <div class="inputs_r">
        ...
        <?php
        if(isset($_POST['generarinformeFR'])){
        ?>
            <form action="reporteinspeccion.php" method="POST" target="_blank">
                    ...
                    <div class="inputs_r">
                        <button class="btn_azul" type="submit" name="capturaubicacionfree">Generar Informe</button>
                    </div>
                </form>
        ...
        ?>
        <div class="inputs_r">
            <input class="btn_azul" type='submit' name="capturaubicacion" value="Guardar">
        </div>
        <?php
        }
        ?>
