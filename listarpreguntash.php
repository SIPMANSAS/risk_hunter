    ...
    if(isset($_POST["identificau"]) or (isset($_POST["idusuario"])))
    {
        ...
        ?>
         <a  class="btn_azul" href="javascript:popUp('agregarcolumnas.php?id=<?php echo $id_pregunta_padre ?>')">Añadir Columna</a>
                    <script type="text/javascript">
                    function popUp(URL) {
                        window.open(URL, 'agregarcolumnas.php?id=<?php echo $id_pregunta_padre ?>', 'toolbar=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0,width=1500,height=500,left = 100,top = 50');
                    }
                    </script>
        <div class="contenedor_titulos">
            <div class=" titulo">
                <b><?php echo  $preguntapadretext = utf8_decode($_POST['nombrepadre']);?></b>
            </div>
        </div>
        
       <div class="contenedor_titulos">
           <?php
            $texto_informe = $_POST['textoinforme'];
            $ayuda = $_POST['ayuda'];
           ?>
            <div class=" titulo"><b>Texto Ayuda</b></div>
            <div class= "titulo"><b>Texto Informe</b></div>
        </div>
